...
# 操作引导
def use_phone_book(people = phone_book()):
    q = ''
    while q!='q':
        goal = input("What do you want to do? Press 'a' to add, Press 'f' to find, Press 'p' to print, Press 'q' to quit.\n")
        if goal == 'a':
            name = input("Name:")
            phone = input("Phone:")
            email = input("Email:")
